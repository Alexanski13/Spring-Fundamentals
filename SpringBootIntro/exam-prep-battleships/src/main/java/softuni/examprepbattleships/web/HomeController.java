...
public class HomeController {
    ...
    @Autowired
    public HomeController(LoggedUser loggedUser, BattleService battleService,
                          UserService userService, ShipRepository shipRepository,
    ...
    public ModelAndView getHome(ModelAndView modelAndView) {
        UserWithShipsModel loggedUserWithShips = battleService.getUserWithShips(loggedUser.getId());
        UserWithShipsModel notLoggedUserWithShips = battleService
                .getUserWithShips(this.userService.findByIdNot(loggedUser.getId()).getId());
